...
def gui():
    ...
    c17 = Checkbutton(frame4, text="Women's Jewelry", variable=check_women_jewelry)
    c18 = Checkbutton(frame4, text="Men's shoes", variable=check_men_shoes)
    c19 = Checkbutton(frame4, text="Women's shoes", variable=check_women_shoes)
